...
import cn.cnu.mobilesafe.utils.StreamUtils;
...
public class SplashActivity extends AppCompatActivity {
    ...
    // 服务器返回的信息
    private String mVersionName;// 版本名,前面的m表示成员变量
        ...
        new Thread() {
            ...
            public void run() {
                ...
                try {
                    ...
                    URL url = new URL("http://172.19.203.88:8080/update.json");
    ...
    // 如果用户取消安装的话,回调此方法,当用户取消安装时进入主页面
    @Override
